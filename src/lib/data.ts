...
export const employees: Employee[] = [
  { id: "1", name: "Alice Johnson", email: "alice.j@example.com", role: "Manager", department: "Engineering", avatar: "/avatars/01.png" },
  { id: "2", name: "Bob Williams", email: "bob.w@example.com", role: "Employee", department: "Engineering", avatar: "/avatars/02.png" },
  { id: "3", name: "Charlie Brown", email: "charlie.b@example.com", role: "Employee", department: "Engineering", avatar: "/avatars/03.png" },
  { id: "4", name: "Diana Prince", email: "diana.p@example.com", role: "Manager", department: "HR", avatar: "/avatars/04.png" },
  { id: "5", name: "Ethan Hunt", email: "ethan.h@example.com", role: "RH", department: "HR", avatar: "/avatars/05.png" },
  { id: "6", name: "Fiona Glenanne", email: "fiona.g@example.com", role: "Manager", department: "Marketing", avatar: "/avatars/06.png" },
  { id: "7", name: "George Costanza", email: "george.c@example.com", role: "Employee", department: "Marketing", avatar: "/avatars/07.png" },
  { id: "8", name: "Hannah Montana", email: "hannah.m@example.com", role: "Owner", department: "Executive", avatar: "/avatars/08.png" },
  { id: "9", name: "Ian Malcolm", email: "ian.m@example.com", role: "Dev", department: "Dev", avatar: "/avatars/09.png" },
];
