...
export const employees: Omit<Employee, 'id'>[] = [
  ...
  { name: "Ethan Hunt", email: "ethan.hunt@hresource.com", role: "RH", department: "HR", avatar: "https://placehold.co/40x40.png?text=EH", hireDate: "2020-11-05", birthDate: "1989-12-15", actif: true, isHr: true, managerName: "Diana Prince", fcmToken: "token-ethan-hunt" },
